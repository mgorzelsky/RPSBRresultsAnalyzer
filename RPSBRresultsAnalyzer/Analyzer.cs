...
namespace RPSBRresultsAnalyzer
{
    ...
    class Analyzer
    {
        ...
        private List<string> TurnResultsToList(string[] unparsedResults)
        {
        ...
        private void RecordResults(List<string> parsedResults)
        {
